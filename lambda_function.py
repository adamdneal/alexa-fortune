"""
Retrieve a random fortune. For use by Linux Fortune skill.
"""
...
def get_welcome_response():
    ...
    session_attributes = {}
    card_title = TITLE
    speech_output = "Ask me for a fortune by saying, give me a fortune."

    # If the user either does not reply to the welcome message or says something
    # that is not understood, they will be prompted again with this text.
    reprompt_text = "Try saying, give me a fortune."
...
def get_random_fortune(session):
    ...
    fortunes_count = get_fortunes_count()
    fortune_id = randint(1, fortunes_count)
    print("fortune_id: {}".format(fortune_id))
